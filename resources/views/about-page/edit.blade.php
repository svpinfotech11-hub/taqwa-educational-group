        ...
        <div class="row g-4">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-info card-outline mb-4">
                    ...
                    <form method="POST" action="{{ route('about-page.update', ['about' => $about->id]) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @if($about->image)
                                    <div class="mt-2">
                                        <img src="{{ asset('about/' .$about->image) }}" alt="Current Banner" width="120" class="rounded border">
