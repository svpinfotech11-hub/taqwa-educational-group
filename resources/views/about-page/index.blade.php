                                    ...
                                    @forelse ($abouts as $about)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @php $firstDetail = $about->details->first(); @endphp

                                                @if ($firstDetail && $firstDetail->image)
                                                    <img src="{{ asset('about/images/' . $firstDetail->image) }}"
                                                        alt="About Image" width="80" height="50"
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form action="{{ route('about-page.destroy', $about->id) }}" method="POST"
