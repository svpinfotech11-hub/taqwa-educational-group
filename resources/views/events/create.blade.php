                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="event_date" id="news_date" class="form-control"
                                            value="{{ old('event_date') }}" placeholder="yyyy-mm-dd" required>
                                    </div>

                                    <!-- Description -->
                                    <div class="col-md-12">
                                        <label for="description" class="form-label">Description</label>
                                        <textarea name="desc" id="description" class="form-control" rows="4" placeholder="Enter news description">{{ old('desc') }}</textarea>
                                    </div>
